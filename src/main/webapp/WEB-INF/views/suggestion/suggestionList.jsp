                     ...
                     <!-- Content --> 
                        ...
                        <section id="banner">
                           ...
                           <header class="major">
                              ...
                              <div>
                                 <form action="suggestionList" method="get">
                                    <select name="demo-category" style="height:25px;">
                                       <option value>- Category -</option>
                                        <option value="suggestion_title"  ${searchItem =='suggestion_title'?'selected' :'' }>제목</option>
                                       <option value="userid" ${searchItem =='userid'?'selected' :'' }>글쓴사람</option>
                                       <option value="reception_date" ${searchItem =='reception_date'? 'selected' :'' }>접수일시</option>
                                    </select>
                           ...
                           <table>
                              ...
                              <c:forEach var="suggestion" items="${list}" varStatus="stat">
                                 <tr> 
                                    <td>${stat.count + navi.startRecord}</td>
                                    <td><a href="suggestionDetail?suggestionseq=${suggestion.suggestionseq}">${suggestion.suggestion_title}</a></td>
                           ...
                           <!-- Paging 시작 -->
                              <div class="text-center">
                                 <ul class="pagination">
                                    <li><a href="suggestionList?currentPage=${navi.currentPage-navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}">◀</a></li><!-- 앞그룹 요청 -->
                                    <li><a href="suggestionList?currentPage=${navi.currentPage-1}&searchItem=${searchItem}&searchWord=${searchWord}">◁</a></li><!-- 앞 페이지 요청 -->
                                    
                                    <c:forEach var="page" begin="${navi.startPageGroup}" end="${navi.endPageGroup }">
                                    <li><a href="suggestionList?currentPage=${page}&searchItem=${searchItem}&searchWord=${searchWord}" class="page active">${page}</a></li>
                                    </c:forEach>
                              ...
                              <div>                              
                              <a href="suggestionWrite" class="button">건의하기</a> 
                              </div>   
