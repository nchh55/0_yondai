         ...
         <!-- Main -->
            <div id="main">
               <div class="inner">
                  ...
                  <div class="box">                                     
                     <h2>공지사항</h2>  
                     	<form method="POST" action="/admin/noticeUpdate">
                        	<div class="row gtr-uniform">
                        	    ...
                        	    <div class="col-3"> 
                       	    	...
                       	    	<div class="col-3">      
                             		작성일자<input type="date" name="notice_date" id="notice_date" value="${notice_date}" />
                          		...
                          		<div class="col-7"></div>
                           		<div class="col-3">
                              		<ul class="actions">
                                 		...
                                 		<li><a href="/noticeList" class="button">수정 취소</a></li>
                              		</ul>
                           		</div>
                           		<div class="col-1"></div>
                        	</div>  
