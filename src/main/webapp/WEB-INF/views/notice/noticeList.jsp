									...
									<div id="user_table">
										...
										<c:if test="${not empty list }">
											<c:forEach var="notice" items="${list}" varStatus="stat">
												<tr>
													<td>${navi.totalRecordCount-(navi.currentPage-1)*navi.countPerPage-(stat.count-1)}</td>
										...
										<!-- Paging 시작 -->
										<ul class="pagination">
											<li><a href="/noticeList?currentPage=${navi.currentPage-navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}">◀</a></li>
											<li><a href="/noticeList?currentPage=${navi.currentPage-1}&searchItem=${searchItem}&searchWord=${searchWord}">◁</a></li>
											<c:forEach var="page" begin="${navi.startPageGroup}" end="${navi.endPageGroup}">
												<c:if test="${page == navi.currentPage}">
													<li><a href="/noticeList?currentPage=${page}&searchItem=${searchItem}&searchWord=${searchWord}" class="page active">${page}</a></li>
												</c:if>
												<c:if test="${page != navi.currentPage }">
													<li><a href="/noticeList?currentPage=${page}&searchItem=${searchItem}&searchWord=${searchWord}" class="page disabled">${page}</a></li>
												</c:if>
											</c:forEach>
											<li><a href="/noticeList?currentPage=${navi.currentPage+1}&searchItem=${searchItem}&searchWord=${searchWord}">▷</a></li>
											<li><a href="/noticeList?currentPage=${navi.currentPage+navi.pagePerGroup}&searchItem=${searchItem}&searchWord=${searchWord}">▶</a></li>
