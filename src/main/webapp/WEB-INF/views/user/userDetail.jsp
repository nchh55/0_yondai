         ...
         <!-- Main -->
            <div id="main">
               <div class="inner">
                  ...
                  <!-- Form --> 
                     <h2>회원정보(상세)</h2>  
                     	<form id="userDetailForm" method="POST" action="/user/userDetail">
                        	<div class="row gtr-uniform">
                        		<div class="col-8">    
                           		...
                           		<div class="col-8">   
                              		<input type="text" name="userphone" id="userphone" value="${userphone}" readonly="readonly" /> 
                          		</div>
                           		<div class="col-5">      
                             		BIRTH : <input type="date" name="userbirth" id="userbirth" value="${userbirth}" readonly="readonly" />
                           		</div>                                                            
                           <!-- Break -->
                           		<div> 장애 유무
                          	  		<c:if test="${disabled == 'YES'}">  
	                          	  		<input type="radio" id="demo-priority-low" name="disabled" value="YES" disabled="disabled" checked>
	                          	  		<label for="demo-priority-low">YES</label> 
                          	  		</c:if>
                          	  		<c:if test="${disabled == 'NO'}">
	                              		<input type="radio" id="demo-priority-low" name="disabled" value="YES" disabled="disabled">
	                          	  		<label for="demo-priority-low">YES</label>
	                          		</c:if>
                           		</div>
                           		<div>
                           	  		<c:if test="${disabled == 'YES'}">  
	                              		<input type="radio" id="demo-priority-normal" name="disabled" value="NO" disabled="disabled">
	                              		<label for="demo-priority-normal">No</label> 
                              		</c:if>
                           	  		<c:if test="${disabled == 'NO'}">  
	                              		<input type="radio" id="demo-priority-normal" name="disabled" value="NO" disabled="disabled" checked >
	                              		<label for="demo-priority-normal">No</label> 
                              		</c:if>
                           		</div> 
                           		<div>
                            	...
                            	<div class="col-11">
                           		...
                           		<div class="col-12">
                              		<ul class="actions">
                                 		<sec:authorize access="hasRole('ROLE_USER')">
                                 			<li><a href="/user/userUpdate?userid=${userid}" class="button primary">수정하기</a></li>
                                 			<li><a href="/user/userDelete?userid=${userid}" class="button primary">탈퇴하기</a></li>
                              			</sec:authorize>
                                 		<sec:authorize access="hasRole('ROLE_ADMIN')">
                                 			<li><a href="/user/userUpdate?userid=${userid}" class="button primary">수정하기</a></li>
                                 			<li><a href="/admin/userDelete?userid=${userid}" class="button primary">탈퇴하기</a></li>
                                 			<li><a href="/admin/userList" class="button big">목록으로</a></li>
                              			</sec:authorize>
                              		</ul>
                           		</div>  
                        	</div>
